  ...
  <div className="container">
    ...
    <ParallaxText baseVelocity={-1.5}>
      <>
        ...
        <img src="/images/kalbefarma.png" alt="Sponsor 5" height={60} />
        <img src="/images/forisa.png" alt="Sponsor 6" height={60} />
        <img src="/images/freshcare.png" alt="Sponsor 7" height={60} />
        <img src="/images/rabbani.png" alt="Sponsor 8" height={60} />
                  ...
                  <div className="activity-card">
                    <div className="card-body">
                      ...
                      <p className="activity-description">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada pretium dui quis fermentum. Nulla pharetra quis eros placerat pretium. Cras iaculis, velit id sagittis commodo, ex libero imperdiet quam, et auctor dolor ex sit amet urna. Nullam feugiat est a porta suscipit. In sit amet dictum nibh. Sed a nunc nec arcu fermentum iaculis sed sed est. Phasellus ac ante venenatis, maximus est eu, efficitur elit. Quisque semper rhoncus ipsum. Sed id lacus mattis diam maximus accumsan vel non quam.


                      </p>
                      <div className="activity-meta">
                        <span className="activity-date">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada pretium dui quis fermentum. Nulla pharetra quis eros placerat pretium. Cras iaculis, velit id sagittis commodo, ex libero imperdiet quam, et auctor dolor ex sit amet urna. Nullam feugiat est a porta suscipit. In sit amet dictum nibh. Sed a nunc nec arcu fermentum iaculis sed sed est. Phasellus ac ante venenatis, maximus est eu, efficitur elit. Quisque semper rhoncus ipsum. Sed id lacus mattis diam maximus accumsan vel non quam.
            ...
            <div className="col-lg-6">
              <div className="activity-card">
                ...
                <div className="card-body">
                  ...
                  <div className="activity-meta">
                    <span className="activity-date">NexGen Dalam Giat Mitigasi Satwa & Feeding </span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="our-office" className="text-center">
        <div className="container">
          ...
          <p className="section-subtitle">
            ...
            konsultasi.
          <h2>this is a map</h2>
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d168.62077383208089!2d106.95457821238986!3d-6.196794576028409!2m3!1f219.1766009385501!2f0!3f0!3m2!1i1024!2i768!4f35!5e1!3m2!1sen!2sid!4v1754998604101!5m2!1sen!2sid" width="600" height="450" style={{border:0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </p>
        </div>
      </section>
