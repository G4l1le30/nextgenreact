  ...
  return (
    <section className="py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-6">
        <div className="relative overflow-hidden rounded-3xl bg-teal-dark shadow-2xl">
          {/* Background Image with Dark Olive Overlay */}
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/kegiatan2.jpg"
              alt="NexGen Workshop Kegiatan"
              fill
          ...
          <div className="relative z-10 p-8 sm:p-12 lg:p-16 max-w-3xl">
            ...
            <h2 className="mt-4 text-3xl font-extrabold leading-tight text-white sm:text-4xl lg:text-5xl">
              Wujudkan Generasi Berkarakter &amp; Peduli Bersama NexGen.
            </h2>

            <p className="mt-4 text-sm leading-relaxed text-slate-300 sm:text-base">
              Siap membawa program edukasi interaktif dan aksi nyata ke sekolah, organisasi, atau komunitas Anda? Hubungi tim kami untuk kemitraan dan jadwal kegiatan.
            </p>

            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a
                href="https://wa.me/6281234567890?text=Halo%20NexGen,%20saya%20tertarik%20untuk%20berkolaborasi"
                target="_blank"
