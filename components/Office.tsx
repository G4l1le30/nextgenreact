export default function Office() {
  return (
    <section id="our-office" className="text-center py-20 bg-dark-slate">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="relative mx-auto max-w-4xl overflow-hidden rounded-xl shadow-lg border border-white/10">
          <iframe
            ...
            className="aspect-[16/10] w-full border-0 filter invert-[90%] hue-rotate-[180deg]"
            allowFullScreen
            loading="lazy"
