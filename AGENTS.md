...
- Section Our Activity (home): 5 aktivitas terbaru via `getActivitiesPage(1, 5)` (grid) + tombol "Lihat Semua Aktivitas"
- Page `/galeri`: semua aktivitas, masonry (CSS columns) + pagination `?page=N` (`PER_PAGE = 12`), tombol Kembali
